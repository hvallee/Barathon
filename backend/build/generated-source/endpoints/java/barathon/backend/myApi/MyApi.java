 ...
 * on 2016-01-21 at 14:02:33 UTC 
 * Modify at your own risk.
 */

package barathon.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Bars extends MyApiRequest<barathon.backend.myApi.model.MyBean> {
     ...
     */
    protected Bars() {
      super(MyApi.this, "GET", REST_PATH, null, barathon.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<barathon.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, barathon.backend.myApi.model.MyBean.class);
